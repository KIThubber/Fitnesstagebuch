...
import HtmlTemplate from "./page-workoutExcercises.html";

/**
 * Klasse PageList: Stellt die Listenübersicht zur Verfügung
 */
 //export default class WorkoutSelection extends Page {
export default class WorkoutExcercises extends Page {
  /**
   * Konstruktor.
   *
   ...
   */
   async init() {
    ...
    let data = await this._app.backend.fetch("GET", "/workoutExcercises");
    ...
    for (let index in data) {
      ...
      .addEventListener(
        "click",
        () => (location.hash = `#/workoutExcercises/${dataset._id}`)
      );
  }
}
}